...
class FitnessAgentScreen extends StatefulWidget {
  const FitnessAgentScreen({Key? key}) : super(key: key);

  @override
  State<FitnessAgentScreen> createState() => _FitnessAgentScreenState();
}

class _FitnessAgentScreenState extends State<FitnessAgentScreen> {
  ...
  Future<void> _loadHistory() async {
    ...
    try {
      ...
      if (userChats is List) {
        ...
        if (fitnessMessages.isNotEmpty) {
          setState(() {
            _messages.clear();
            _messages.addAll(fitnessMessages);
          });
          return;
        }
      }
    ...
    if (_messages.isEmpty) {
      _messages.add({
        'role': 'assistant',
        'content':
            'Hello! I\'m your Fitness Coach. I can help you with personalized exercise routines and fitness advice based on your health conditions and fitness goals. What would you like to know about fitness?',
        'agent': 'fitness',
      });
    }
  }
                ...
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: AppStrings.get('askFitness', lang),
